...
//
// Modified (slightly) to output standard avr 14 byte string with leading asterix
// by Timothy Quill <doodybutch@hotmail.com>
...
static void checksum_and_send(uint8_t *frame, int len, uint32_t parity)
{
    ...
    // Add standard avr asterix to frame and send it out
